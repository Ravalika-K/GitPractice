...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-53CAHRUR;Database=BikeStores;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E276EA4C454");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4BBE905FB");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85A44E8712");
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("orders", tb => tb.HasTrigger("trgAfterInsertOrder"));
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229F4B37AE1");
        ...
        {
            entity.HasKey(e => e.AuditId).HasName("PK__order_au__5AF33E333FCD67B7");
        ...
        {
            entity.HasKey(e => e.OrderItemsId).HasName("PK__order_it__75291555CA7058D6");

            entity.ToTable("order_items", tb => tb.HasTrigger("trgCheckOrderQuantity"));
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4A11CF05F");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF56E385216");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C34267C3A");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61648276A31E").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D374F2F04E");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C636E4872");
